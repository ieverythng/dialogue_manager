...
from dialogue_manager_skill_msgs.action import DialogueManager

from diagnostic_msgs.msg import DiagnosticArray, DiagnosticStatus, KeyValue


class DialogueManagerSkillImpl(Node):
    """
    Implementation of dialogue_manager.
    ...
    def __init__(self) -> None:
        """Construct the node."""
        super().__init__('skill_dialogue_manager')
        ...
        self.get_logger().info('Skill dialogue_manager started, but not yet configured.')
    ...
    def on_request_exec(self, goal_handle):
        ...
        return DialogueManager.Result(value=f"{res}")
    ...
    def on_configure(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Skill dialogue_manager is configured, but not yet active")
    ...
    def on_activate(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Skill dialogue_manager is active and running")
    ...
    def on_deactivate(self, state: State) -> TransitionCallbackReturn:
        ...
        self.get_logger().info("Skill dialogue_manager is stopped (inactive)")
    ...
    def on_shutdown(self, state: State) -> TransitionCallbackReturn:
        ...
        :return: The state machine either invokes a transition to the
            ...
            "errorprocessing"
        """
        self.get_logger().info('Shutting down dialogue_manager skill.')
        ...
        self.get_logger().info("Skill dialogue_manager finalized.")
        return TransitionCallbackReturn.SUCCESS
    ...
    def publish_diagnostics(self):
        ...
        msg = DiagnosticStatus(
            ...
            name="/skill/dialogue_manager",
            message="skill dialogue_manager is running",
            values=[
                KeyValue(key="Module name", value="dialogue_manager"),
    ...
    def run(self) -> None:
        ...
        self.get_logger().info("skill dialogue_manager: performing background task...")
